    ...
    return(
        ...
        <div className="project1-container">
            <div className="project1-description-wrapper">
                <div className="project1-description-title">Project 6</div>
                <div className="project1-description-text">
                                    This is an App that called ‘food finder’,
                    where you can find about 500 of foods’ recipes,
                    and even provide you a youtube tutorial
                    link where you and navigate to and watch!
                </div>
            </div>
            ...
            <div className="project1-source-code-wrapper">
                ...
                <div className="project1-source-code-link">github</div>
            </div>
            <div className="project1-site-link-wrapper">
                <div className="project1-site-title">visit</div>
                <div className="project1-site-link">links</div>
            </div>
        </div>
        </>
    )
